    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
        	<form  action="prosesedit/ppinjedit.php" name="modal_popup"  enctype="multipart/form-data" method="POST" onsubmit="return true;">
                ...
                <input type="hidden" name="tanggal_dibayar"  class="form-control" value="<?php date_default_timezone_set('Asia/Jakarta'); echo date(' Y-m-d H:i:s');?>" />

	            <div class="modal-footer">
	                <button class="btn btn-success" type="submit" name="update2" value="update2">
	                    Update
	                </button>
