...
?>
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <?php
include "prosestambah/tambahadmin.php"
?>
				<!-- Add Project -->
		                            ...
		                            while($res = mysqli_fetch_array($result)) {	
                                     ...
                                     ?>	
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="editadmin.php?&id_user=<?php echo addslashes($res['id_user']);?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
														<a href="hapus/hadmin.php?act=hapus&id_user=<?php echo addslashes($res['id_user']);?>&namafile=<?php echo addslashes($res['foto_user']);?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
													</div>												
												</td>												
                                            </tr>
                                            <?php
