...
//including the database koneksi file
    ...
    {
                                        $id_user = $res['id_user'];
                                        $peserta = mysqli_query($koneksi, "SELECT nama_lengkap,id_user,hak_akses FROM user WHERE id_user = $id_user");
                                        $psrt = mysqli_fetch_assoc($peserta);
                                        $id_user2 = $res['id_user2']; 
                                        $pelatih = mysqli_query($koneksi, "SELECT nama_lengkap,id_user,hak_akses FROM user WHERE id_user = $id_user2");
                                        $plth = mysqli_fetch_assoc($pelatih);
        $id_nilai = $res['id_nilai'];
        $kode_nilai = $res['kode_nilai'];
        $tanggal = $res['tanggal'];
        $posisi = $res['posisi'];
        $bobot1 = $res['bobot1'];
        $bobot2 = $res['bobot2'];
        ...
        $bobot4 = $res['bobot4'];
        $bobot5 = $res['bobot5'];
        $nama_lengkap = $psrt['nama_lengkap'];
        $nama_lengkap3 = $plth['nama_lengkap'];
        $id_user = $psrt['id_user'];
        $id_user3 = $plth['id_user'];
    }
?>
 <?php
// including the database koneksi file
...
{	
    ...
    {	
		//updating the table
	    $result = mysqli_query($mysqli, "UPDATE nilai SET kode_nilai='$kode_nilai', 
        id_user='$id_user', 
        id_user2='$id_user2', 
        tanggal='$tanggal', 
        posisi='$posisi', 
        ...
        bobot3='$bobot3', 
        bobot4='$bobot4', 
        bobot5='$bobot5' WHERE id_nilai=$id_nilai");
        echo "<script>window.alert('Data Berhasil DI Ubah')
        window.location='nilai'</script>";
	}
}
?>
                                ...
                                <div class="profile-tab">
                                    <div class="custom-tab-1">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-item"><a href="#profile-settings" data-toggle="tab" class="nav-link active show">Edit Nilai #<?php echo $nama_lengkap; ?> </a>
                                            </li>
                                        </ul>
                                            ...
                                            <div id="profile-settings" class="tab-pane fade active show">
                                                <div class="pt-3">
                                                    <div class="settings-form">
                                                        <h4 class="text-primary">Edit Nilai</h4>
                                                        ...
                                                        <input type="hidden" name="id_nilai" value="<?php echo $id_nilai; ?>">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" placeholder="Email" value='<?php echo $kode_nilai; ?>' readonly name='kode_nilai' class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Nama Peserta</label>
                                                                    <input type="text" placeholder="Password" value='<?php echo $nama_lengkap; ?>' readonly  class="form-control">
                                                                    <input type="hidden"  value='<?php echo $id_user; ?>'  name='id_user' class="form-control">
                                                                    <input type="hidden"  value='<?php echo $id_user3; ?>'  name='id_user2' class="form-control">

                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                <label>Nama Pelatih</label>
                                                                    <input type="text" placeholder="Email" value='<?php echo $nama_lengkap3; ?>' readonly  class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Tanggal</label>
                                                                    <input type="date" placeholder="tanggal" value='<?php echo $tanggal; ?>' name='tanggal'   class="form-control">              
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                <label>Posisi</label>
