...
<head>
    ...
    <title>Zenix - Crypto peserta Dashboard </title>
    <!-- Favicon icon -->
	<?php
...
?>
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <?php
include "prosestambah/tambahpeserta.php"
?>
				<!-- Add Project -->
						...
						<div class="modal-content">
                            ...
                            <form action="peserta" method="POST" enctype='multipart/form-data'>
									<div class="form-group">
                                        ...
                                        <input type="hidden" name="hak_akses" value="user" class="form-control">
									</div>
									<div class="form-group">
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#addProjectSidebar">Tambah Pegawai</button>
		                            ...
		                            while($res = mysqli_fetch_array($result)) {	
                                     ...
                                     ?>	
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
                                                    <a href="editpeserta.php?&id_user=<?php echo addslashes($res['id_user']);?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
														<a href="hapus/hpeserta.php?act=hapus&id_user=<?php echo addslashes($res['id_user']);?>&namafile=<?php echo addslashes($res['foto_user']);?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
													</div>												
												</td>												
                                            </tr>
                                            <?php
