...
$result = mysqli_query($mysqli, "SELECT * FROM nilai where id_user = '$id_user2' ");
?>
		                            ...
		                            while($res = mysqli_fetch_array($result)) {	
                                        ...
                                        $hasil = $res['bobot1'] + $res['bobot2'] + $res['bobot3'] + $res['bobot4'] + $res['bobot5'];
                                     ?>	
                                            <tr>
                                           <td><?php echo addslashes($res['kode_nilai']);?></td>
                                                ...
                                                <td><?php echo addslashes($hasil);?></td>
