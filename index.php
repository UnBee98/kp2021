...
$Pending = mysqli_query($mysqli, "select * from pinjaman where id_user = '$id_user2' AND status='Pending' ");
$Pending = mysqli_num_rows($Pending);

$Dikonfirmasi = mysqli_query($mysqli, "select * from pinjaman where id_user = '$id_user2' AND status='Dikonfirmasi' ");
$Dikonfirmasi = mysqli_num_rows($Dikonfirmasi);

$Ditransfer = mysqli_query($mysqli, "select * from pinjaman where id_user = '$id_user2' AND status='Ditransfer' ");
$Ditransfer = mysqli_num_rows($Ditransfer);

$Selesai = mysqli_query($mysqli, "select * from pinjaman where id_user = '$id_user2' AND status='Selesai' ");
$Selesai = mysqli_num_rows($Selesai);

$Ditolak = mysqli_query($mysqli, "select * from pinjaman where id_user = '$id_user2' AND status='Ditolak' ");
$Ditolak = mysqli_num_rows($Ditolak);
					...
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<?php
                    $x = mysqli_query($mysqli,"select sum(jml_pinjaman) as total from pinjaman where  id_user = '$id_user2' AND status='Selesai'");
                    $p4 = mysqli_fetch_array($x);
                    	{
                    
                   ?>
								<h2 class="text-black mb-2 font-w600">Rp <span><?php echo addslashes(number_format($p4['total']));?></h2>
								<?php } ?>
								<p class="mb-0 fs-14">
									...
									<span class="text-success mr-1"><?php echo $Selesai ; ?></span>Jumlah Dana Selesai
								</p>	
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<?php
                    $x = mysqli_query($mysqli,"select sum(jml_pinjaman) as total from pinjaman where  id_user = '$id_user2' AND status='Pending'");
                    $p5 = mysqli_fetch_array($x);
                    	{
                    
                   ?>
								<h2 class="text-black mb-2 font-w600">Rp <span><?php echo addslashes(number_format($p5['total']));?></h2>
								<?php } ?>
								<p class="mb-0 fs-13">
									<svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<span class="text-success mr-1"><?php echo $Pending ?></span>Jumlah Dana Pending
								</p>	
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<?php
                    $x = mysqli_query($mysqli,"select sum(jml_pinjaman) as total from pinjaman where  id_user = '$id_user2' AND status='Dikonfirmasi'");
                    $p6 = mysqli_fetch_array($x);
                    	{
                    
                   ?>
								<h2 class="text-black mb-2 font-w600">Rp <span><?php echo addslashes(number_format($p6['total']));?></h2>
								<?php } ?>
								<p class="mb-0 fs-14">
									<svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<span class="text-danger mr-1"><?php echo $Dikonfirmasi ?></span>Jumlah Dana Di Konfirmasi
								</p>	
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<?php
                    $x = mysqli_query($mysqli,"select sum(jml_pinjaman) as total from pinjaman where  id_user = '$id_user2' AND status='Ditolak'");
                    $p7 = mysqli_fetch_array($x);
                    	{
                    
                   ?>
								<h2 class="text-black mb-2 font-w600">Rp <span><?php echo addslashes(number_format($p7['total']));?></h2>
								<?php } ?>								<p class="mb-0 fs-14">
									<svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<span class="text-success mr-1"><?php echo $Ditolak ?></span> Jumlah Dana Ditolak
								</p>	
							</div>
						</div>
					</div>
