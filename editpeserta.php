...
{	
    ...
    else 
    {
        ...
        swal({
        title: "Good job!",
        text: "Data peserta Berhasil DI Ubah",
        icon: "success",
        button: "oke!",
        }).then(function() {
        window.location = "./";
    ...
    else
    {
        ...
        swal({
        title: "Good job!",
        text: " Foto peserta Berhasil DI Ubah",
        icon: "success",
        button: "oke!",
        }).then(function() {
        window.location = "./";
                                                        ...
                                                        <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" placeholder="Email" value='<?php echo $username; ?>' name='username' readonly class="form-control">
                                                                </div>
                                                                <div class="form-group col-md-6">
